...
import com.android.signal.MyIceServer;
import com.android.signal.RTCSignalClient;
import com.android.utils.MediaCapturer;
...
public class CallActivity extends AppCompatActivity {
    ...
    private RTCSignalClient mSignalClient = PEApplication.INSTANCE.mSignalClient;//信号客户端
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userId=PEApplication.INSTANCE.getUserLogin();//获取该用户账号
        ...
        PEApplication.INSTANCE.setCallActivity(activity);
     ...
     */
    private void updateCallState(boolean isCall,boolean isVoice) {
    ...
    private PeerConnection.Observer mPeerConnectionObserver = new PeerConnection.Observer() {
        @Override        public void onSignalingChange(PeerConnection.SignalingState signalingState) {//在 SignalingState 更改时触发。
