...
import com.android.ui.message.ReceiveCallActivity;
...
public class RTCSignalClient {
   ...
   //
   private static  final  String WS_URL = "ws://47.99.53.217:8099";
   //private static  final  String WS_URL = "ws://192.168.43.170:8099";
    ...
    private Context context =PEApplication.INSTANCE.getBaseContext();
    ...
    public class JWebSocketClient extends WebSocketClient {
        ...
        public void onOpen(ServerHandshake handshakedata) { // 说明websocket连接成功
            ...
            try {
                ...
                args.put("uid", PEApplication.INSTANCE.getUserLogin());
            ...
            try {
                ...
                switch (cmd){
                      case SIGNAL_TYPE_INVITE_SUCCEED:
                          ...
                          if (mUserId.equals(PEApplication.INSTANCE.getUserLogin())){//是对方账号时
