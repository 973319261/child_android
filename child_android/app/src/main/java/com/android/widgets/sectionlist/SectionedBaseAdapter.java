...
import com.android.widgets.sectionlist.PinnedHeaderListView.PinnedSectionedHeaderAdapter;



public abstract class SectionedBaseAdapter<T> extends BaseAdapter implements
	...
	public abstract T getItem(int section, int position);
	...
	public abstract ViewGroup getSectionHeaderView(int section,
			View convertView, ViewGroup parent);
