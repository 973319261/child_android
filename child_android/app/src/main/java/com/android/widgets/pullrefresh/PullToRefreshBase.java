...
import com.android.widgets.pullrefresh.internal.FlipLoadingLayout;
import com.android.widgets.pullrefresh.internal.LoadingLayout;
import com.android.widgets.pullrefresh.internal.RotateLoadingLayout;
import com.android.widgets.pullrefresh.internal.Utils;
import com.android.widgets.pullrefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	protected OnHeaderScrollListener mOnHeaderScrollListener;
	...
	@Override
	public void setOnHeaderScrollListener(OnHeaderScrollListener mListener) {
		this.mOnHeaderScrollListener = mListener;
	}
	...
	protected final void setHeaderScroll(int value) {
		setHeaderScroll(value, false);
	}
	protected final void setHeaderScroll(int value, boolean stop) {
		if (DEBUG) {
		...
		if (this.mOnHeaderScrollListener != null && false == stop) {
			this.mOnHeaderScrollListener.onScroll(value, mLayoutVisibilityChangesEnabled);
		}
		switch (getPullToRefreshScrollDirection()) {
			case VERTICAL:
				scrollTo(0, value);
	...
	public static interface OnHeaderScrollListener {
		public void onScroll(int scrollY, boolean s);
	}
