...
public class CirclePageIndicator extends View implements PageIndicator {
    ...
    private boolean mIsDragging, isHintMode;
    ...
    public CirclePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        mCentered = a.getBoolean(R.styleable.CirclePageIndicator_iCentered, defaultCentered);
        mOrientation = a.getInt(R.styleable.CirclePageIndicator_orientation, defaultOrientation);
        mPaintStroke = new Paint(Paint.ANTI_ALIAS_FLAG);
        mSolid = a.getBoolean(R.styleable.CirclePageIndicator_solid, true);
        mPaintStroke.setStyle(mSolid ? Style.FILL_AND_STROKE : Style.STROKE);
        mPaintStroke.setColor(a.getColor(R.styleable.CirclePageIndicator_strokeColor, defaultStrokeColor));
        mPaintStroke.setStrokeWidth(a.getDimension(R.styleable.CirclePageIndicator_strokeWidth, defaultStrokeWidth));
        mPaintFill = new Paint(Paint.ANTI_ALIAS_FLAG);
        mPaintFill.setStyle(Style.FILL);
        mPaintFill.setColor(a.getColor(R.styleable.CirclePageIndicator_fillColor, defaultFillColor));
        mRadius = a.getDimension(R.styleable.CirclePageIndicator_iRadius, defaultRadius);
        mSnap = a.getBoolean(R.styleable.CirclePageIndicator_iSnap, defaultSnap);
