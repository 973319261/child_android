...
/**
 * Created by jac_cheng on 2017/4/14.
 */
...
//        params.addBodyParameter("version", AppUtil.getVersionName(PEApplication.INSTANCE));
//        params.addBodyParameter("versionCode", AppUtil.getVersionCode(PEApplication.INSTANCE));
